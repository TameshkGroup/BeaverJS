...
export declare class Puya {
    ...
    addSubscribe(path: string, fn: (value: Value, path: (string | number | symbol)[]) => void, klass?: string, throttle?: number): string;
    addSubscribe(fn: (value: Value, path: (string | number | symbol)[]) => void, klass?: string, throttle?: number): string;
